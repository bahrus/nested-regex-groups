...
- [x] 4. Phase 1: Extract flat group parsing modules
  - [x] 4.1 Create parse-grouped-captures.ts module
    - Extract `parseGroupedCaptures` function from index.ts
    - Ensure zero library dependencies (uses standard regex)
    - Add type imports
    - _Requirements: 1.1, 8.2_
  
  - [x] 4.2 Create parse-grouped-capture-statements.ts module
...
- [x] 5. Phase 1: Extract nested statement parsing module
  - [x] 5.1 Create parse-pattern-statements.ts module
...
- [x] 6. Checkpoint - Verify module extraction
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Phase 2: Update barrel export (index.ts)
  - [x] 7.1 Replace function implementations with re-exports
...
- [x] 8. Phase 3: Update template.ts imports
  - [x] 8.1 Update template.ts to import from specific modules
...
- [x] 9. Phase 4: Update package.json configuration
  - [x] 9.1 Add subpath exports for all 13 modules
  ...
  - [x] 9.2 Update files array with all new module files
...
- [x] 10. Phase 5: Build and verify TypeScript compilation
...
- [x] 12. Phase 5: Run test suite and verification
...
- [x] 13. Documentation updates
  - [x] 13.1 Update README with subpath import documentation
  ...
  - [x] 13.2 Add migration guide to README
